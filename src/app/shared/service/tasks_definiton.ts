...
export const tasks_definition = [
  ...
  },
  {
    ...
    german_description: "Berechnen Sie die Summe der Zellen I9 und J9 in Zelle K9.",
  ...
  },
  {
    ...
    german_hint: "Berechnung: Summe Stunden/Monat, z.B. G13 = SUMME(G7:G11)",
    english_hint: "Calculation: Total hours/month, e.g. G13 = SUM(G7:G11)",
        // " F13=SUM(F7:F11)\n" +
        // " G13=SUM(G7:G11)\n" +
        // " H13=SUM(H7:H11)\n" +
        // " I13=SUM(I7:I11)\n" +
  ...
  },
  {
    ...
    german_hint: "Berechnung: Brutto Stundensatz, z.B. D10 = C10+C15*C10",
    english_hint: "Calculation: gross hourly rate, e.g. D10 = C10+C15*C10",
        // " gross = net + overhead\n" +
        // " D7=C7+C$15*C7\n" +
        // " D8=C8+C$15*C8\n" +
        // " D9=C9+C$15*C9\n" +
